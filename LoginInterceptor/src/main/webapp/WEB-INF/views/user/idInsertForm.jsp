    ...
    <body>
        <div class="frame" style="overflow: hidden;">
			...
			<!-- 		<div class="pw_informationbox ">
					...
					<div class="textbox">
						<input type="text" placeholder="사용자 ID" name="userid" class=" xCenter" required>
					</div>
					<div class="pswbox">
						<input type="password" placeholder="비밀번호" name="userpw" class=" xCenter" required>
					</div>
					<div class="textbox">
						<input type="text" placeholder="사용자  이름" name="usernm" class=" xCenter" required>
					</div>
					<div class="textbox">
						<input type="text" placeholder="Email" name="email" class=" xCenter" required>
					</div>
					...
					<div class="pw_buttonbox">
						<div class="pw_button xyCenter">
							<button type="submit" id="" class="change">회원가입</button>
